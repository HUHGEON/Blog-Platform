...
const userSchema = new mongoose.Schema({
  id: {
    type: String,
    required: [true, '사용자 아이디는 필수입니다'],
    unique: true,
    trim: true,
    minlength: [3, '아이디는 3글자 이상이어야 합니다'],
    maxlength: [10, '아이디는 10글자 이하여야 합니다']
  },
  pw: {
    type: String,
    required: [true, '비밀번호는 필수입니다'],
    minlength: [8, '비밀번호는 8글자 이상이어야 합니다'],
    maxlength: [15, '비밀번호는 15글자 이하여야 합니다'],
    validate: {
      ...
      message: '비밀번호는 8-16자리이며, 영문자와 숫자만 사용 가능합니다(공백 불가)'
    }
  },
  name: {
    type: String,
  ...
  nickname: {
    ...
    maxlength: [10, '닉네임은 15글자 이하여야 합니다']
  },
  birth_date: {
    type: Date,
